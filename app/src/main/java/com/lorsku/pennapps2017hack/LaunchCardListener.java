...
public class LaunchCardListener implements View.OnTouchListener {

    private static final String TAG = LaunchCardListener.class.getSimpleName();
    ...
    public LaunchCardListener(View frame, Object itemAtPosition, float rotation_degrees, FlingListener flingListener) {
        super();
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                //SlideCardFragment.removeBackground();
    ...
    private float getExitPoint(int exitXPoint) {
        ...
        LinearComeback regression = new LinearComeback(x, y);
