...
/**
 * **********************************************************************
 * Compilation:  javac LinearComeback.java
 * Execution:    java  LinearComeback
 * <p/>
...
/**
 *  The <tt>LinearComeback</tt> class performs a simple linear regression
...
class LinearComeback {
     ...
     */
    public LinearComeback(float[] x, float[] y) {
